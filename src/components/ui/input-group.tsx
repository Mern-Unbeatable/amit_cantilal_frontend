...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      role="group"
      className={cn(
        'group/input-group border-border placeholder:text-muted-foreground placeholder:text-sm dark:bg-input/30 relative flex w-full items-center rounded-md border shadow-xs transition-[color,box-shadow] outline-none',
