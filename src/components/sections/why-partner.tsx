...
const stats = [
  { icon: Car, value: '7+', label: 'Premium models' },
  { icon: Users, value: '48', label: 'People per group' },
  { icon: DollarSign, value: '15-20%', label: 'Commission per booking' },
  { icon: Clock, value: '24/7', label: 'Dedicated support' },
  { icon: Shield, value: 'VIP', label: 'Exclusive services' },
  { icon: Leaf, value: '70%+', label: 'Electric fleet' },
]
