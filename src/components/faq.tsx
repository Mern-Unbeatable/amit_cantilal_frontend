...
const FAQ = forwardRef<HTMLDivElement, FAQProps>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn("w-full max-w-4xl mx-auto p-0 space-y-8", className)}
        {...props}
      >
        {/* Header */}
                ...
                >
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                      ...
                      <h3 className="text-base md:text-xl font-semibold text-gray-800 group-hover:text-gray-900 transition-colors duration-300">
                        {faq.question}
                      </h3>
                    </div>
                    <div
                ...
                >
                  <div className="px-6 pb-6">
                    <div className="pl-12">
                      ...
                      <p className="text-gray-700 leading-relaxed text-sm md:text-lg animate-fadeIn">
                        {faq.answer}
                      </p>
                    </div>
                  </div>
