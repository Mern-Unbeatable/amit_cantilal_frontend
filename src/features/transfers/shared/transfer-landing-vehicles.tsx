...
export function TransferLandingVehicles({
  ...
  return (
    <section className="bg-[#0F0F0F] py-20 md:py-32 border-t border-[#C9A84C]/10">
      <div className="container mx-auto px-6 md:px-12 max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 gap-6 md:gap-8">
          {vehicles.map((vehicle, index) => (
            <motion.article
              ...
              transition={{ duration: 0.55, ease: landingEase, delay: index * 0.1 }}
            >
              ...
              <div className="p-6 md:p-8">
                <h3 className="font-serif text-xl md:text-2xl font-light text-[#F5F0E8] mb-4">
        ...
        <motion.p
          className="mt-12 md:mt-16 text-center text-sm md:text-base text-[#F5F0E8]/55 font-light leading-relaxed max-w-2xl mx-auto"
          {...fadeUp}
        >
          {t('vehicles.note')}
        </motion.p>
