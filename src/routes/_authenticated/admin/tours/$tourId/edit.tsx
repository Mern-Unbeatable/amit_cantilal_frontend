    ...
    form.reset({
      ...
      price:
        typeof tour.price === 'number'
          ? tour.price
          : typeof tour.price_eur === 'number'
            ? Math.round(tour.price_eur / 100)
            : 0,
      duration:
        tour.duration ??
      ...
      category: (tour.category ?? 'private'),
                ...
                render={({ field }) => (
                  <FormItem>
                    <Field>
                      ...
                      <FormControl>
                        <Textarea id="excerpt" rows={3} {...field} />
                      </FormControl>
                ...
                render={({ field }) => (
                  <FormItem>
                    <Field>
                      ...
                      <FormControl>
                        <Textarea id="description" rows={6} {...field} />
                      </FormControl>
                      <FieldError
                ...
                render={({ field }) => (
                  <FormItem>
                    <Field>
                      ...
                      <FormControl>
                        <Textarea id="inclusions" rows={4} {...field} />
                      </FormControl>
                ...
                render={({ field }) => (
                  <FormItem>
                    <Field>
                      ...
                      <FormControl>
                        <Textarea id="exclusions" rows={4} {...field} />
                      </FormControl>
